...
export const pages: Page[] = [
    ...
    },
    {
        ...
        title: "Things To Do",
        description:
            "Discover attractions and activities near The Red Cow Nantwich. Explore historic sites, local shops, outdoor activities, and nearby destinations in Cheshire and beyond.",
        components: [
            {
                type: "PageHeading",
                heading: "Things To Do",
                paragraphs: [
                    "Discover the best attractions and activities near The Red Cow in Nantwich.",
                ],
