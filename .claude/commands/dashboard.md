...
Read `.claude/docs/logging-strategy.md` for the available dimensions and message conventions, then search the codebase for the **exact** log messages and dimension names relevant to the request. You need real strings to write accurate queries — don't guess.
