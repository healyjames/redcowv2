...
| `architecture` | keep code within the project's architecture (hexagonal / layered / vertical); reads `.claude/docs/architecture.md` | `/dev`, `code-review`; `/install` sets the pattern |
